...
<table class="table">
  <thead class="table table-danger table-striped">
    <tr>
      ...
      <th scope="col">Mentor_Department</th>
      <th scope="col">Mentor_username</th>
      <th scope="col">Mentor_password</th>
      <th scope="col">Mentor_Idea_id</th>
    </tr>
